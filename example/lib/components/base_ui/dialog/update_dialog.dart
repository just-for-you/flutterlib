...
import 'package:flutterlib_example/utils/image_utils.dart';
import 'package:flutterlib_example/utils/theme_utils.dart';
import 'package:flutterlib_example/utils/version_utils.dart';
import 'package:flutterlib_example/utils/toast.dart' as toast;
...
class _UpdateDialogState extends State<UpdateDialog> {
  ...
  Future<void> _download() async {
    try {
      ...
      File file = File(path);
      /// 链接可能会失效
      await Dio().download('https://j2.58cdn.com.cn/m58/app58/m_static/apiwap/img/ZTEMarket_III-release_V3.7_58tongcheng.apk?PGTID=0d000000-0000-0833-058b-6123b8b610b8&ClickID=4',
        file.path,
