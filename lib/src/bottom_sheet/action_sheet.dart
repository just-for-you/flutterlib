...
enum ActionSheetStyle { roundedCard, filled }
...
class ActionSheet extends StatelessWidget {
  ActionSheet(
      ...
      this.style = ActionSheetStyle.roundedCard,
      this.borderRadius,
      @required this.child,
      this.cancelButton})
      : assert(child != null),
  ...
  /// [ActionSheetStyle.roundedCard] & [ActionSheetStyle.filled].
  /// Default value is [ActionSheetStyle.roundedCard], like iOS style.
  ...
  bool _isRound() {
    return style == ActionSheetStyle.roundedCard;
  }
...
class _ActionSheetCancelButton extends StatefulWidget {
  const _ActionSheetCancelButton({Key key, this.child, this.isRound = true}) : super(key: key);
